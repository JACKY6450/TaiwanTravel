  ...
  <div class="kaosiungInfo">
    ...
    <header class="header">
      <div class="container text-center">
        <h1 class="text-white" style="margin-bottom: 95px">離島旅遊資訊</h1>
...
import { outerIsland } from '@/static/PopularCity.js'
...
export default {
  ...
  methods: {  
    ...
    setPopular() {
      let popularSet = [];
      let cityInform = outerIsland.cityInform;
...
<style scoped> 
  .header {
    background: url("../../assets/pic/bannerLienchiang.jpg");
