  ...
  <div class="kaosiungInfo">
    ...
    <header class="header">
      <div class="container text-center">
        <h1 class="text-white" style="margin-bottom: 95px">北部旅遊資訊</h1>
...
import { northCity } from '@/static/PopularCity.js'
...
export default {
  ...
  methods: {  
    ...
    setPopular() {
      let popularSet = [];
      let cityInform = northCity.cityInform;
...
<style scoped> 
  .header {
    background: url("../../assets/pic/bannerTaipei.jpg");
